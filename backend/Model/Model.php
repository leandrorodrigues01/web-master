...
class Model
{
    ...
    {
        $query = "SELECT users.*, endereco.*
                  FROM users
                  LEFT JOIN endereco ON users.id = endereco.iduser";
    ...
    public function getUserWithAddresses($id)
    {
        $query = "SELECT users.*, endereco.*
                      FROM users
                      LEFT JOIN endereco ON users.id = endereco.iduser
    ...
    {
        $query =
            "SELECT * FROM vw_perfil_permissoes WHERE perfilid = :perfilid";
    ...
    ";
        ...
        if ($resultado) {
            return $resultado["perfilid"];
        } else {
            return "Usuario/permissões não encontradas";
        }
    }
}
